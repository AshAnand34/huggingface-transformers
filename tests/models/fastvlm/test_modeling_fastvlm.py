...
"""Testing suite for the PyTorch FastVLM model."""
...
class FastVLMForConditionalGenerationIntegrationTest(unittest.TestCase):
    def setUp(self):
        self.processor = AutoProcessor.from_pretrained("fastvlm-hf/bakFastVLM-v1-hf")
    ...
    def test_small_model_integration_test(self):
        ...
        model = FastVLMForConditionalGeneration.from_pretrained("fastvlm-hf/bakFastVLM-v1-hf", load_in_4bit=True)

        prompt = "<image>\nUSER: What are the things I should be cautious about when I visit this place?\nASSISTANT:"
        image_file = "https://fastvlm-vl.github.io/static/images/view.jpg"
    ...
    def test_small_model_integration_test_llama_single(self):
        # Let's make sure we test the preprocessing to replace what is used
        model_id = "fastvlm-hf/fastvlm-1.5-7b-hf"

        model = FastVLMForConditionalGeneration.from_pretrained("fastvlm-hf/fastvlm-1.5-7b-hf", load_in_4bit=True)
    ...
    def test_small_model_integration_test_llama_batched(self):
        ...
        image1 = Image.open(requests.get("https://fastvlm-vl.github.io/static/images/view.jpg", stream=True).raw)
    ...
    def test_small_model_integration_test_llama_batched_regression(self):
        ...
        model = FastVLMForConditionalGeneration.from_pretrained(
            "fastvlm-hf/fastvlm-1.5-7b-hf", load_in_4bit=True, attn_implementation="eager"
        )
    ...
    def test_batched_generation(self):
        ...
        processor = AutoProcessor.from_pretrained("fastvlm-hf/fastvlm-1.5-7b-hf")
    ...
    def test_tokenizer_integration(self):
        slow_tokenizer = AutoTokenizer.from_pretrained("liuhaotian/fastvlm-v1.6-34b", use_fast=False)
        slow_tokenizer.add_tokens("<image>", True)

        fast_tokenizer = AutoTokenizer.from_pretrained(
            "liuhaotian/fastvlm-v1.6-34b",
    ...
    def test_generation_no_images(self):
        model_id = "fastvlm-hf/fastvlm-1.5-7b-hf"
        model = FastVLMForConditionalGeneration.from_pretrained(model_id, load_in_4bit=True)
        processor = AutoProcessor.from_pretrained(model_id)
    ...
    def test_generation_siglip_backbone(self):
        model_id = "fastvlm-hf/fastvlm-interleave-qwen-0.5b-hf"
        model = FastVLMForConditionalGeneration.from_pretrained(model_id, torch_dtype="float16", device_map=torch_device)
        processor = AutoProcessor.from_pretrained(model_id)
    ...
    def test_pixtral(self):
        ...
        model = FastVLMForConditionalGeneration.from_pretrained(model_id)
        processor = AutoProcessor.from_pretrained(model_id)
