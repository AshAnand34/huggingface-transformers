...
class FastVLMConfig(PretrainedConfig):
    ...
    e.g. [fastvlm-hf/fastvlm-9b](https://huggingface.co/fastvlm-hf/fastvlm-9b)
    ...
    >>> # Initializing a FastVLM fastvlm-1.5-7b style configuration
    >>> configuration = FastVLMConfig(vision_config, text_config)

    >>> # Initializing a model from the fastvlm-1.5-7b style configuration
