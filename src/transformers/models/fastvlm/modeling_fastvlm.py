...
from .configuration_fastvlm import FastVLMConfig
...
@dataclass
# Copied from transformers.models.llava.modeling_llava.LlavaModelOutputWithPast with Llava->FastVLM
...
@dataclass
# Copied from transformers.models.llava.modeling_llava.LlavaCausalLMOutputWithPast with Llava->FastVLM
...
# Copied from transformers.models.llava.modeling_llava.LlavaMultiModalProjector with Llava->FastVLM
...
@auto_docstring
# Copied from transformers.models.llava.modeling_llava.LlavaPreTrainedModel with Llava->FastVLM,llava->fastvlm
class FastVLMPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        # important: this ported version of FastVLM isn't meant for training from scratch - only
        # inference and fine-tuning - so the proper init weights code has been removed - the original codebase
        # https://github.com/haotian-liu/LLaVA/tree/main/fastvlm should serve for that purpose
...
# Copied from transformers.models.llava.modeling_llava.LlavaModel with Llava->FastVLM
...
# Copied from transformers.models.llava.modeling_llava.LlavaForConditionalGeneration with Llava->FastVLM,llava->fastvlm
class FastVLMForConditionalGeneration(FastVLMPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        >>> model = FastVLMForConditionalGeneration.from_pretrained("fastvlm-hf/fastvlm-1.5-7b-hf")
...
__all__ = ["FastVLMForConditionalGeneration", "FastVLMPreTrainedModel", "FastVLMModel"]
