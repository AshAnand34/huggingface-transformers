...
"""Fast Image processor class for FastVLM."""
...
class FastVLMFastImageProcessorKwargs(DefaultFastImageProcessorKwargs):
    """
    Args:
...
@auto_docstring
class FastVLMImageProcessorFast(BaseImageProcessorFast):
    ...
    do_normalize = True
    do_convert_rgb = True
    valid_kwargs = FastVLMFastImageProcessorKwargs

    def __init__(self, **kwargs: Unpack[FastVLMFastImageProcessorKwargs]) -> None:
        super().__init__(**kwargs)

    @auto_docstring
    def preprocess(self, images: ImageInput, **kwargs: Unpack[FastVLMFastImageProcessorKwargs]) -> BatchFeature:
...
__all__ = ["FastVLMImageProcessorFast"]
